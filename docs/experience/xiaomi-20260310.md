...
- 深度分页问题怎么优化
  ...
  参考[实战！聊聊如何解决 MySQL 深分页问题](https://juejin.cn/post/7012016858379321358)。
  </details>
...
- MySQL 死锁
  ...
  参考[深入解析 MySQL 死锁：原因、检测与解决方案](https://zhuanlan.zhihu.com/p/1923372599213290775)
  </details>
...
- 针对当日步数怎么实现排行榜功能？相同步数的情况下先达成该步数的排在前面
  ...
  参考[基于 Redis 的 zset 命令实现排行榜功能](https://zhuanlan.zhihu.com/p/494306764)
  </details>
